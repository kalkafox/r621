  ...
  return renderWarning ? (
    ...
    >
      <a.div
        ...
        onMouseEnter={() => updateSpring(warningBoxSpringApi, { scale: 1.02 })}
      ...
      >
        <div
          className={`lg:text-6xl sm:text-3xl portrait:text-2xl w-content bg-black portrait:w-full w-4/5 m-auto p-8 rounded-3xl ${poppins.className}`}
        >
          <Icon
            className="w-full"
        ...
        <div
          className={`portrait:space-x-8 portrait:text-sm lg:space-x-48 sm:space-x-12 md:space-x-8 py-8 text-2xl ${poppins.className}`}
        >
          <a.button
            style={agreeSpring}
            onMouseEnter={() => {
